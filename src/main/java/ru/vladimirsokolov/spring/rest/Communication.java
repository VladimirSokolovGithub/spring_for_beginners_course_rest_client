...
public class Communication {
    ...
    private final String URL = "http://localhost:8080/spring_for_beginners_course_mvc_rest_api/api/employees/";
    ...
    //метод для сохранения нового работника и изменения существующего
